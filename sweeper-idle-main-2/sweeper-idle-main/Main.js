...
define("Boilerplate/Classes/Context2D", ["require", "exports", "Boilerplate/Enums/Align"], function (require, exports, Align_1) {
    ...
    CanvasRenderingContext2D.prototype.setFont = function (font, size) {
        this.font = "".concat(size, "px ").concat(font);
    };
});
...
define("Game/Enums/CellStates", ["require", "exports"], function (require, exports) {
    ...
    })(CellStates || (exports.CellStates = CellStates = {}));
});
define("Game/Enums/CellTypes", ["require", "exports"], function (require, exports) {
    ...
    })(CellTypes || (exports.CellTypes = CellTypes = {}));
});
...
define("Game/Classes/Points", ["require", "exports", "Boilerplate/Classes/GameBase", "Boilerplate/Enums/Align", "Boilerplate/Enums/Fonts", "Boilerplate/Enums/MouseButton", "Boilerplate/Functions", "Game/Classes/Colours"], function (require, exports, GameBase_1, Align_2, Fonts_1, MouseButton_3, Functions_1, Colours_1) {
    ...
    var Points = /** @class */ (function () {
        ...
        Points.prototype.update = function (context, input) {
            ...
            this.pointsText = "Points: ".concat(this.points);
            ...
            if (input.isReleased(MouseButton_3.MouseButton.Left) && !input.getLeftUsed()
                && (0, Functions_1.pointWithinRectangle)(input.getX(), input.getY(), this.rectX, this.rectY, this.rectW, this.rectH)) {
                input.setLeftUsed();
            }
...
define("Game/Classes/Grid", ["require", "exports", "Boilerplate/Classes/GameBase", "Boilerplate/Classes/Vector2", "Boilerplate/Enums/Align", "Boilerplate/Enums/Fonts", "Boilerplate/Enums/MouseButton", "Boilerplate/Functions", "Game/Enums/CellStates", "Game/Enums/CellTypes", "Game/Enums/Upgrades", "Game/Classes/Colours"], function (require, exports, GameBase_2, Vector2_3, Align_3, Fonts_2, MouseButton_4, Functions_2, CellStates_1, CellTypes_1, Upgrades_2, Colours_3) {
    ...
    var Grid = /** @class */ (function () {
        function Grid(width, height) {
            ...
            this.cellValues = (0, Functions_2.createMultidimensionalArray)(width, height, 0);
            this.cellTypes = (0, Functions_2.createMultidimensionalArray)(width, height, CellTypes_1.CellTypes.Clear);
            this.cellStates = (0, Functions_2.createMultidimensionalArray)(width, height, CellStates_1.CellStates.Covered);
            this.width = width;
            this.height = height;
            this.generateMines();
        ...
        Grid.prototype.generateMines = function () {
            ...
            while (minesLeft > 0) {
                var x = (0, Functions_2.randomInt)(0, this.width - 1);
                var y = (0, Functions_2.randomInt)(0, this.height - 1);
                if (this.cellTypes[x][y] !== CellTypes_1.CellTypes.Mine) {
                    this.cellTypes[x][y] = CellTypes_1.CellTypes.Mine;
                    minesLeft--;
                }
        ...
        Grid.prototype.runRevealerUpgrade = function (cellValue, points) {
            ...
            if (covered.length > 0) {
                var random = covered[(0, Functions_2.randomInt)(0, covered.length - 1)];
...
define("Game/Classes/Shop", ["require", "exports", "Boilerplate/Enums/Align", "Boilerplate/Enums/Fonts", "Boilerplate/Enums/MouseButton", "Boilerplate/Functions", "Game/Classes/Colours"], function (require, exports, Align_5, Fonts_4, MouseButton_5, Functions_3, Colours_5) {
    ...
    var Shop = /** @class */ (function () {
        ...
        Shop.prototype.update = function (input, upgradeManager, points, tooltip) {
            ...
            if ((0, Functions_3.pointWithinRectangle)(input.getX(), input.getY(), this.titleRectX, this.titleRectY, this.titleRectW, this.titleRectH + this.upgradeOffset + ((upgrades.length - upgrades.length % 3) / 3 + 1) * (this.upgradeHeight + this.upgradeOffset))) {
                if (input.isReleased(MouseButton_5.MouseButton.Left) && !input.getLeftUsed()) {
                    input.setLeftUsed();
                    upgrades.forEach(function (x, i) {
                        if ((0, Functions_3.pointWithinRectangle)(input.getX(), input.getY(), _this.mainRectX + _this.upgradeOffset + (_this.upgradeOffset + _this.upgradeWidth) * (i % 3), _this.mainRectY + _this.upgradeOffset + (_this.upgradeOffset + _this.upgradeHeight) * ((i - i % 3) / 3), _this.upgradeWidth, _this.upgradeHeight)) {
        ...
        Shop.prototype.draw = function (context, upgradeManager, points, input) {
            ...
            upgrades.forEach(function (x, i) {
                ...
                else if ((0, Functions_3.pointWithinRectangle)(input.getX(), input.getY(), _this.mainRectX + _this.upgradeOffset + (_this.upgradeOffset + _this.upgradeWidth) * (i % 3), _this.mainRectY + _this.upgradeOffset + (_this.upgradeOffset + _this.upgradeHeight) * ((i - i % 3) / 3), _this.upgradeWidth, _this.upgradeHeight))
...
define("Game/Classes/AudioManager", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var AudioManager = /** @class */ (function () {
        ...
        AudioManager.prototype.startScheduler = function () {
            var _this = this;
            this.stopScheduler();
            this.schedulerTimer = window.setInterval(function () { return _this.scheduleNotes(); }, 100);
        };
        AudioManager.prototype.stopScheduler = function () {
            if (this.schedulerTimer !== null) {
                window.clearInterval(this.schedulerTimer);
                this.schedulerTimer = null;
            }
        };
        AudioManager.prototype.scheduleNotes = function () {
        ...
        AudioManager.prototype.playNote = function (frequency, time) {
...
define("Game/Classes/MusicButton", ["require", "exports", "Boilerplate/Enums/Align", "Boilerplate/Enums/Fonts", "Boilerplate/Enums/MouseButton", "Boilerplate/Functions", "Game/Classes/Colours"], function (require, exports, Align_6, Fonts_5, MouseButton_6, Functions_4, Colours_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MusicButton = void 0;
    var MusicButton = /** @class */ (function () {
        function MusicButton() {
            this.width = 60;
            this.height = 60;
        }
        MusicButton.prototype.update = function (input, audioManager, canvasWidth) {
            var x = canvasWidth - this.width - 20;
            var y = 20;
            if ((0, Functions_4.pointWithinRectangle)(input.getX(), input.getY(), x, y, this.width, this.height)) {
                if (input.isReleased(MouseButton_6.MouseButton.Left) && !input.getLeftUsed()) {
                    input.setLeftUsed();
                    audioManager.toggle();
                }
            }
        };
        MusicButton.prototype.draw = function (context, audioManager, canvasWidth) {
            var x = canvasWidth - this.width - 20;
            var y = 20;
            context.drawBorderedRectangle(x, y, this.width, this.height, Colours_6.Colours.boxUncovered, Colours_6.Colours.boxBorder);
            var label = audioManager.isPlaying() ? '||' : '♫';
            context.drawString(label, x + this.width / 2, y + this.height / 2 + 4, 28, Fonts_5.Fonts.Arial, Colours_6.Colours.green, Align_6.Align.Center);
        };
        return MusicButton;
    }());
    exports.MusicButton = MusicButton;
});
define("Game/Classes/Game", ["require", "exports", "Game/Classes/Grid", "Game/Classes/Camera", "Boilerplate/Classes/Vector2", "Boilerplate/Classes/GameBase", "Game/Classes/Points", "Game/Classes/Shop", "Game/Classes/UpgradeManager", "Game/Classes/Tooltip", "Game/Classes/AudioManager", "Game/Classes/MusicButton"], function (require, exports, Grid_1, Camera_1, Vector2_4, GameBase_3, Points_1, Shop_1, UpgradeManager_1, Tooltip_1, AudioManager_1, MusicButton_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Game = void 0;
    var Game = /** @class */ (function (_super) {
        ...
        Game.prototype.initialize = function () {
            ...
            this.musicButton = new MusicButton_1.MusicButton();
        };
