...
export class Grid {
    ...
    save(): any {
        return {
            ...
            cellUncover1Timer: this.cellUncover1Timer,
            cellUncover2Timer: this.cellUncover2Timer,
            cellUncover3Timer: this.cellUncover3Timer,
            cellUncover4Timer: this.cellUncover4Timer,
            flagger1Timer: this.flagger1Timer,
            flagger2Timer: this.flagger2Timer,
            flagger3Timer: this.flagger3Timer,
            flagger4Timer: this.flagger4Timer
        };
    }
    ...
    load(data: any): boolean {
        ...
        try {
            ...
            this.cellTypes = data.cellTypes;
            this.cellStates = data.cellStates;
            this.cellUncover1Timer = data.cellUncover1Timer || 0;
            this.cellUncover2Timer = data.cellUncover2Timer || 0;
            this.cellUncover3Timer = data.cellUncover3Timer || 0;
            this.cellUncover4Timer = data.cellUncover4Timer || 0;
            this.flagger1Timer = data.flagger1Timer || 0;
            this.flagger2Timer = data.flagger2Timer || 0;
            this.flagger3Timer = data.flagger3Timer || 0;
            this.flagger4Timer = data.flagger4Timer || 0;
            return true;
        } catch (e) {
